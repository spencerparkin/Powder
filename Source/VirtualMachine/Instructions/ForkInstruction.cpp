...
namespace Powder
{
	...
	/*virtual*/ Executor::Result ForkInstruction::Execute(uint8_t* programBuffer, uint64_t programBufferSize, uint64_t& programBufferLocation, Executor* executor, VirtualMachine* virtualMachine)
	{
